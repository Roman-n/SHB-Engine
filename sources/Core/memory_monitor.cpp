...
STATIC const char* output_folder = "x:/memory_monitor_stats/";
...
void memory_monitor::monitor_alloc		(const void *allocation_address, const u32 &allocation_size, const char* allocation_description)
{
	if (!use_monitor())
		return;
