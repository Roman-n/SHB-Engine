...
IRender_Visual*	CModelPool::Instance_Load(const char* name, IReader* data, BOOL allow_register)
{
	IRender_Visual	*V;
...
void		CModelPool::Instance_Register(const char* N, IRender_Visual* V)
{
	// Registration
	ModelDef			M;
	M.name				= N;
...
IRender_Visual* CModelPool::Instance_Find(const char* N)
{
...
IRender_Visual* CModelPool::CreateChild(const char* name, IReader* data)
{
