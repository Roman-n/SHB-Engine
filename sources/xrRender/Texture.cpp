...
void				TW_Save	(IDirect3DTexture9* T, const char* name, const char* prefix, const char* postfix)
{
...
IDirect3DBaseTexture9*	CRender::texture_load(const char* fRName, u32& ret_msize)
{
