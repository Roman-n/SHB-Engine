...
CWeaponMagazinedWGrenade::CWeaponMagazinedWGrenade(const char* name, ESoundTypes eSoundType) : CWeaponMagazined(name, eSoundType)
{
	m_ammoType2 = 0;
...
//если мы в режиме стрельбы очередями, переключиться на одиночные, а уже потом на подствольник
...
bool CWeaponMagazinedWGrenade::Action(int cmd, u32 flags)
{
