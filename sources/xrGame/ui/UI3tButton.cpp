...
void CUI3tButton::InitTexture(const char* tex_name)
{
...
void CUI3tButton::InitTexture(const char* tex_enabled, const char* tex_disabled, const char* tex_touched, const char* tex_highlighted)
{
