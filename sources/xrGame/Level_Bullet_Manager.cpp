...
void CBulletManager::Load		()
{
	...
	const char* whine_sounds		= pSettings->r_string(BULLET_MANAGER_SECTION, "whine_sounds");
	...
	const char* explode_particles= pSettings->r_string(BULLET_MANAGER_SECTION, "explode_particles");
