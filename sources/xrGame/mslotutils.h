...
public:
	...
	inline void  SetBuffer(LPCSTR b, int sz){Reset(); _memcpy(m_buff,b,sz); m_len=sz; m_pos=0;};
	...
	inline BOOL	w_string(LPCSTR dst){
...
inline HANDLE CreateMailSlotByName(char* slotName)
{
