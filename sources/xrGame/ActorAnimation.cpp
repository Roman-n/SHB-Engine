...
void STorsoWpn::Create(CKinematicsAnimated* K, const char* base0, const char* base1)
{
	char			buf[128];
...
void SAnimState::Create(CKinematicsAnimated* K, const char* base0, const char* base1)
{
	char			buf[128];
